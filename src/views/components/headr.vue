<template>
    <div class="headr">
        <block>
            <Row type="flex" justify="space-between" class="code-row-bg" slot="inner">
                <Col>
                <div class="logo">
              ...
              HOT!
                ...
                <div class="tools">
                    ...
                    <Button id="btnLogin" type="primary" size="normal" shape="circle" @click="login()">登录</Button>
                    <Button id="btnReg" size="normal" shape="circle">注册</Button>
                </div>
                </Col>
            </Row>
        </block>
