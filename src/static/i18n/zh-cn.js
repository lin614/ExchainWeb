module.exports = {
  ...
  etPage: {
    what: {
      title: '什么是ET?',
      descript: 'ET是Exchain交易平台本身的权益证明，发行总量恒定100亿，将平均分10年全部发给交易用户和伙伴以及投资者，技术团队，并且永不增发，Exchain将全部收入分配给ET持有者'
    },
    etRight: {
      title: 'ET持有者权利',
      descript: [{
  ...
  partnerPage: {
    title: 'Exchain超级伙伴合作计划开启 打造交易共赢新时代',
    p1: 'Exchain 数字货币交易所即将上线，平台采用交易即挖矿模式，用户Exchain交易即可获得交易量的平台币奖励，即日起，Exchain开启“超级合作伙伴”计划。',
    p2: '每一位Exchain交易所的用户只需邀请新用户到交易所进行交易，就可以成为“普通合作伙伴”，普通合作伙伴可获得交易所的平台币奖励，同时还能获得收入分成。',
  ...
  userCenter: {
    ...
    kyc: {
      ...
      back: '证件背面',
      hold: '手持证件照片',
      holdErrorTip: '手持证件照片的问题',
      passportFront: '护照封面',
      passportBack: '护照信息页',
      passportHold: '手持护照信息页',
      passportHoldErrorTip: '手持护照信息页的问题',
      tip: '上传身份证件信息',
      pleaseUpload: '请上传',
      ...
      standard: {
        ...
        text2: '人物头像清晰；',
        text3: '身份证件信息清晰；',
        text4: '证件照旁展示一张写有：EXCHAIN+注册邮箱+申请日期的纸张信息；',
        text5: '完整的展示您的手臂，不要完全遮挡躯干部分。'
      },
      submit: '申请提交'
    },
    // 提现地址管理
  ...
  baiduApiError: {
    '4': '集群超限额',
    '6': '没有接口权限',
    '14': 'IAM鉴权失败，建议用户参照文档自查生成sign的方式是否正确，或换用控制台中aksk的方式调用',
    '17':	'每天流量超限额，或者免费赠送的调用次数已经用完',
    '18':	'QPS超限额',
    '19':	'请求总量超限额',
    ...
    '216501': '传入的生活照中没有找到人脸',
    '216600': '身份证格式错误，请检查后重新输入',
    '216601': '身份证号码与姓名不匹配，或无法找到此身份证号码',
    '216602': '输入生活照人脸遮挡，质量检测不通过',
    '216603': '人脸光照不好，质量检测不通过',
    '216604': '人脸不完整，质量检测不通过',
    '216605': '人脸置信度低，质量检测不通过',
    '216606': '人脸模糊，质量检测不通过',
    '216607': '公安库无此人图片或公安小图质量不佳',
    '216608': '输入的生活照活体校验不通过',
    '216609': '人脸左右角度过大',
    '216610': '人脸俯仰角度过大',
    '222001': '参数格式错误',
    '222002': '参数格式错误',
